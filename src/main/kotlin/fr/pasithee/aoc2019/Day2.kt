...
fun main() {
    val input = arrayListOf(1L,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,6,1,19,1,5,19,23,2,6,23,27,1,27,5,31,2,9,31,35,1,5,35,39,2,6,39,
    ...
    for (i in 0L..99) {
        for (j in 0L..99) {
            ...
            if (programCandidate[0] == 19690720L) {
                println(i * 100 + j)
                return
            }
        }
